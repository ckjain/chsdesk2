Rails.application.config.sorcery.submodules = [:user_activation, :http_basic_auth, :reset_password, :session_timeout, :brute_force_protection, :activity_logging, :external]
